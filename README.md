...
**How To Use** : Put all these files in  _==/home/$USER/.config/polybar/==_  and execute  _==launch.sh==_  to start the polybar or add this script to your WM startup file. <br />
